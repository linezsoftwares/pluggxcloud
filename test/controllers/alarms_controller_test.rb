...
class AlarmsControllerTest < ActionController::TestCase
  ...
  test "should create alarm" do
    assert_difference('Alarm.count') do
      post :create, alarm: { days: @alarm.days, enabled: @alarm.enabled, name: @alarm.name, start: @alarm.start, stop: @alarm.stop }
    end
  ...
  test "should update alarm" do
    patch :update, id: @alarm, alarm: { days: @alarm.days, enabled: @alarm.enabled, name: @alarm.name, start: @alarm.start, stop: @alarm.stop }
    assert_redirected_to alarm_path(assigns(:alarm))
  end
